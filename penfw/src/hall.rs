...
use crate::{
    board_init::{i2c_device_present, HALL_SENSOR_ADDR},
...
pub fn read_hall_telemetry(i2c: &mut I2c<'_, Blocking>, hall: &mut HallSensor) -> HallTelemetry {
    hall.read_telemetry(i2c)
}
